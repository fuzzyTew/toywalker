...
#ifdef HAVE_NO_VECTOR
    virtual const int * GetFree() const = 0;
#else
...
#ifdef HAVE_NO_VECTOR
    virtual size_t AddSolution(const IkSingleDOFSolutionBase<T> * vinfos, const int * vfree) = 0;
#else
