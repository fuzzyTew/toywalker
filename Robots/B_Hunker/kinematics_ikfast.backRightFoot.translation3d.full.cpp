...
///
/// ikfast version 0x10000049 generated on 2017-07-17 21:08:56.126195
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
                                                            ...
                                                            {
                                                                {
                                                                    ...
                                                                    CheckValue<IkReal> x202=IKPowWithIntegerCheck<IkReal>(((((-3300.0)*x200))+(((-3600.0)*pz))+(((-1188.0)*sj5))),-1);
                                                                    if(!x202.valid)
                                                                    {
                                                                        continue;
                                                                    }
                                                                    ...
                                                                    if( IKabs(((x202.value)*(((1089.0)+(((-10000.0)*(pz*pz)))+(((-1089.0)*(cj5*cj5))))))) < IKFAST_ATAN2_MAGTHRESH && IKabs(((x203.value)*(((((272.25)*cj5*sj5))+x201)))) < IKFAST_ATAN2_MAGTHRESH && IKabs(IKsqr(((x202.value)*(((1089.0)+(((-10000.0)*(pz*pz)))+(((-1089.0)*(cj5*cj5)))))))+IKsqr(((x203.value)*(((((272.25)*cj5*sj5))+x201))))-1) <= IKFAST_SINCOS_THRESH )
                                                                    {
                                                                        continue;
                                                                    }
                                                    ...
                                                    {
                                                        {
                                                            ...
                                                            _nj4 = 1;
                                                            IkReal x211=(pz*sj5);
                                                            CheckValue<IkReal> x212=IKPowWithIntegerCheck<IkReal>(((4.32)+(((3.96)*cj5))+(((-11.0)*x211))),-1);
                                                            if(!x212.valid)
                                                            {
                                                                continue;
                                                            }
                                                            CheckValue<IkReal> x213=IKPowWithIntegerCheck<IkReal>(((-432.0)+(((-396.0)*cj5))+(((1100.0)*x211))),-1);
                                                            if(!x213.valid)
                                                            {
                                                                continue;
                                                            }
                                                            if( IKabs(((x212.value)*(((((-3.63)*cj5*sj5))+(((12.0)*pz))+(((-3.96)*sj5)))))) < IKFAST_ATAN2_MAGTHRESH && IKabs(((x213.value)*(((69.0)+(((363.0)*(cj5*cj5))))))) < IKFAST_ATAN2_MAGTHRESH && IKabs(IKsqr(((x212.value)*(((((-3.63)*cj5*sj5))+(((12.0)*pz))+(((-3.96)*sj5))))))+IKsqr(((x213.value)*(((69.0)+(((363.0)*(cj5*cj5)))))))-1) <= IKFAST_SINCOS_THRESH )
                                                            {
                                                                continue;
                                                            }
                                                        ...
                                                        {
                                                            {
                                                                ...
                                                                CheckValue<IkReal> x262=IKPowWithIntegerCheck<IkReal>(IKsign(((12.96)+(((100.0)*(pz*pz)))+(((100.0)*x256))+((x261*(px*px)))+(((-1.0)*x256*x261))+(((200.0)*x258*x259))+(((72.0)*x258))+(((72.0)*x259)))),-1);
                                                                if(!x262.valid)
                                                                {
                                                                    continue;
                                                                }
                                                ...
                                                {
                                                    {
                                                        ...
                                                        CheckValue<IkReal> x280=IKPowWithIntegerCheck<IkReal>(IKsign(((12.96)+(((36.0)*x276))+(((36.0)*x278))+(((11.88)*cj5))+(((-33.0)*pz*sj5))+((x278*x279))+((x276*x279)))),-1);
                                                        if(!x280.valid)
                                                        {
                                                            continue;
                                                        }
                                        ...
                                        {
                                            {
                                                ...
                                                CheckValue<IkReal> x298=IKPowWithIntegerCheck<IkReal>(IKsign(((2385.0)+(((2376.0)*cj5)))),-1);
                                                if(!x298.valid)
                                                {
                                                    continue;
                                                }
